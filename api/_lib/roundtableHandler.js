...
证据强度标签【强共识】【存在争议】【证据不足】【规范空白】不用每次发言都挂在开头，改为放在关键结论前标注；日常陈述用自然语言。比如："你引用的那个研究，我查了一下，只做了单基因遗传病，样本32个病人，随访两年。这个结论要外推到多基因性状，我不认为站得住。"引用模拟研究、单一来源或有争议的结论时，必须点明局限。
...
发言可以短，可以停顿。未解决分歧放在末尾，用自然语言写出来，不用编号。
